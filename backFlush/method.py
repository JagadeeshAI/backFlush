...
if __name__ == "__main__":
    ...
    p.add_argument("--lora_path", default="outputs_detection/20251230_215824/final", help="Path to trained LoRA")
    p.add_argument("--main_path", default="data/data.json")
    p.add_argument("--aux_path", default="data/aux.json")
    p.add_argument("--watermark_key_path", default="outputs_detection/20251230_215824/keys/watermark_key.json", help="Path to watermark_key.json")
